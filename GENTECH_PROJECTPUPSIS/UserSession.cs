...
namespace GENTECH_PROJECTPUPSIS
{
    public static class UserSession
    {
        ...
        public static int CreationYear { get; private set; }
        public static string FormattedID { get; private set; }
        ...
        public static void SetStudentData(
            int studentId, string firstName, string lastName, string email,
            string contactNumber, DateTime birthDate, int? yearLevel, int? programId,
            string programCode = null, string programName = null,
            int? sectionId = null, string sectionName = null,
            string password = null, int creationYear = 0)
        {
            ClearSession();
            UserID = studentId;
            ...
            FormattedID = IDFormatter.FormatStudentID(studentId, creationYear);
            IsLoggedIn = true;
        }

        // ==================== SET FACULTY DATA ====================
        public static void SetFacultyData(
     int facultyId, string firstName, string lastName, string email,
     int? departmentId, string departmentName = null,
     string password = null, int creationYear = 0)
        {
            ClearSession();
            UserID = facultyId;
            ...
            CreationYear = creationYear;
            FormattedID = IDFormatter.FormatFacultyID(facultyId, creationYear);
            IsLoggedIn = true;
        }

        // ==================== SET ENROLLMENT STAFF DATA ====================
        public static void SetEnrollmentStaffData(
    int credentialId, int studentId, string firstName, string lastName,
    string email, string contactNumber, DateTime birthDate, int? yearLevel,
    int? programId, string programCode = null, string programName = null,
    int? sectionId = null, string sectionName = null,
    string password = null, int creationYear = 0)
        {
            ClearSession();
            ...
            SectionName = sectionName;
            CreationYear = creationYear;
            FormattedID = IDFormatter.FormatEnrollmentID(credentialId, creationYear);
            IsLoggedIn = true;
        }

        // ==================== SET ADMIN DATA ====================
        public static void SetAdminData(
    int adminId, string firstName, string lastName, string email,
    string roleDescription, string middleName = null, string suffix = null,
    string contactNumber = null, string address = null, string sex = null,
    DateTime? birthDate = null, string password = null, int creationYear = 0)
        {
            ClearSession();
            UserID = adminId;
            UserRole = ROLE_ADMIN;
            ...
            CreationYear = creationYear;
            FormattedID = IDFormatter.FormatAdminID(adminId, creationYear);
            IsLoggedIn = true;
        }
