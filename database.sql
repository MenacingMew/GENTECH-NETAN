CREATE DATABASE  IF NOT EXISTS `gentchdb_admin` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `gentchdb_admin`;
-- MySQL dump 10.13  Distrib 8.0.46, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: gentchdb_admin
-- ------------------------------------------------------
...
-- Dump completed on 2026-06-04  8:45:48
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2026-06-03 14:42:40',NULL),('diagnostics.include_raw','OFF','2026-06-03 14:42:40',NULL),('ps_thread_trx_info.max_length','65535','2026-06-03 14:42:40',NULL),('statement_performance_analyzer.limit','100','2026-06-03 14:42:40',NULL),('statement_performance_analyzer.view',NULL,'2026-06-03 14:42:40',NULL),('statement_truncate_len','64','2026-06-03 14:42:40',NULL);
...
-- Dump completed on 2026-06-04  8:45:49
CREATE DATABASE  IF NOT EXISTS `gentechdb_admin` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `gentechdb_admin`;
-- MySQL dump 10.13  Distrib 8.0.46, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: gentechdb_admin
-- ------------------------------------------------------
-- Server version	8.0.46
...
INSERT INTO `admin` VALUES (1,'System','Admin','admin','123','Administrator'),(2,'System','Admin2','admin2','123','Administrator'),(3,'System','Admin3','Priolo','123','Administrator');
...
CREATE TABLE `assessment` (
  ...
  CONSTRAINT `assessment_ibfk_1` FOREIGN KEY (`Schedule_ID`) REFERENCES `schedule` (`Schedule_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `curriculum` (
  ...
  CONSTRAINT `curriculum_ibfk_1` FOREIGN KEY (`Program_ID`) REFERENCES `program` (`Program_ID`),
  CONSTRAINT `curriculum_ibfk_2` FOREIGN KEY (`Course_ID`) REFERENCES `course` (`Course_ID`),
  CONSTRAINT `curriculum_ibfk_3` FOREIGN KEY (`Semester_ID`) REFERENCES `semester` (`Semester_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `enrollment_details` (
  `Enrollment_Detail_ID` int NOT NULL AUTO_INCREMENT,
  `Enrollment_ID` int NOT NULL,
  `Schedule_ID` int NOT NULL,
  PRIMARY KEY (`Enrollment_Detail_ID`),
  KEY `Enrollment_ID` (`Enrollment_ID`),
  KEY `Schedule_ID` (`Schedule_ID`),
  CONSTRAINT `enrollment_details_ibfk_1` FOREIGN KEY (`Enrollment_ID`) REFERENCES `enrollment` (`Enrollment_ID`),
  CONSTRAINT `enrollment_details_ibfk_2` FOREIGN KEY (`Schedule_ID`) REFERENCES `schedule` (`Schedule_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `enrollment_schedule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `enrollment_schedule` (
  `Enrollment_Schedule_ID` int NOT NULL AUTO_INCREMENT,
  `Semester_ID` int NOT NULL,
  ...
  KEY `Semester_ID` (`Semester_ID`),
  CONSTRAINT `enrollment_schedule_ibfk_1` FOREIGN KEY (`Semester_ID`) REFERENCES `semester` (`Semester_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `enrollment_schedule` WRITE;
/*!40000 ALTER TABLE `enrollment_schedule` DISABLE KEYS */;
/*!40000 ALTER TABLE `enrollment_schedule` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `grade_overview`
--
...
CREATE TABLE `grade_overview` (
  `Grade_Overview_ID` int NOT NULL AUTO_INCREMENT,
  `Student_ID` int NOT NULL,
  `Schedule_ID` int NOT NULL,
  ...
  PRIMARY KEY (`Grade_Overview_ID`),
  KEY `Student_ID` (`Student_ID`),
  KEY `Schedule_ID` (`Schedule_ID`),
  CONSTRAINT `grade_overview_ibfk_1` FOREIGN KEY (`Student_ID`) REFERENCES `student` (`Student_ID`),
  CONSTRAINT `grade_overview_ibfk_2` FOREIGN KEY (`Schedule_ID`) REFERENCES `schedule` (`Schedule_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `grade_overview`
--

LOCK TABLES `grade_overview` WRITE;
/*!40000 ALTER TABLE `grade_overview` DISABLE KEYS */;
/*!40000 ALTER TABLE `grade_overview` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `grades` (
  ...
  CONSTRAINT `grades_ibfk_2` FOREIGN KEY (`Assessment_ID`) REFERENCES `assessment` (`Assessment_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment` (
  ...
  `Statement_Of_Account_ID` int NOT NULL,
  `Student_ID` int NOT NULL,
  ...
  KEY `Statement_Of_Account_ID` (`Statement_Of_Account_ID`),
  KEY `Student_ID` (`Student_ID`),
  CONSTRAINT `payment_ibfk_1` FOREIGN KEY (`Statement_Of_Account_ID`) REFERENCES `statement_of_account` (`Statement_Of_Account_ID`),
  CONSTRAINT `payment_ibfk_2` FOREIGN KEY (`Student_ID`) REFERENCES `student` (`Student_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `schedule` (
  ...
  KEY `Room_ID` (`Room_ID`),
  CONSTRAINT `schedule_ibfk_1` FOREIGN KEY (`Section_ID`) REFERENCES `section` (`Section_ID`),
  ...
  CONSTRAINT `schedule_ibfk_4` FOREIGN KEY (`Room_ID`) REFERENCES `room` (`Room_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `semester` (
  ...
  `Academic_Year` varchar(35) NOT NULL,
...
CREATE TABLE `statement_of_account` (
  `Statement_Of_Account_ID` int NOT NULL AUTO_INCREMENT,
  `Student_ID` int NOT NULL,
  `Semester_ID` int NOT NULL,
  ...
  PRIMARY KEY (`Statement_Of_Account_ID`),
  KEY `Student_ID` (`Student_ID`),
  KEY `Semester_ID` (`Semester_ID`),
  CONSTRAINT `statement_of_account_ibfk_1` FOREIGN KEY (`Student_ID`) REFERENCES `student` (`Student_ID`),
  CONSTRAINT `statement_of_account_ibfk_2` FOREIGN KEY (`Semester_ID`) REFERENCES `semester` (`Semester_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `subject_offering` (
  ...
  KEY `Schedule_ID` (`Schedule_ID`),
  KEY `Semester_ID` (`Semester_ID`),
  CONSTRAINT `subject_offering_ibfk_1` FOREIGN KEY (`Curriculum_ID`) REFERENCES `curriculum` (`Curriculum_ID`),
  CONSTRAINT `subject_offering_ibfk_2` FOREIGN KEY (`Schedule_ID`) REFERENCES `schedule` (`Schedule_ID`),
  CONSTRAINT `subject_offering_ibfk_3` FOREIGN KEY (`Semester_ID`) REFERENCES `semester` (`Semester_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `teststudent` WRITE;
/*!40000 ALTER TABLE `teststudent` DISABLE KEYS */;
INSERT INTO `teststudent` VALUES (1,'Charls','BSIT','0',20);
/*!40000 ALTER TABLE `teststudent` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2026-06-04  8:45:50
